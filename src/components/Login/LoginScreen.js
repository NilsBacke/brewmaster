...
export default function LoginScreen() {
  ...
  return (
    <div className="h-100 d-flex flex-column">
      <h1 className="text-center mb-5 mt-4">Brewmaster</h1>
      <div className="d-flex flex-row flex-grow-1 align-items-center mb-5">
        <div className="form-group flex-grow-1 me-5">
          ...
          />
          <Button title="Login" onClick={login} className="mt-4" />
        </div>
        <div className="form-group flex-grow-1 ms-5">
